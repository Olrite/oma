...
public class Rectangle extends SearchAreaMode
{
    ...
    {
        double speedBPS = 10.0; // BoatFly removed in Meteor 1.21.11
...
//            path complete
            ...
            if (searchArea.disconnectOnCompletion.get())
            {
                ...
                mc.player.networkHandler.onDisconnect(new DisconnectS2CPacket(Text.literal("[Area Searcher] Path is complete")));
            }
